...
- [spell](https://github.com/rockscy/spell) An inline AI command palette that translates plain-English requests into shell commands, edited and executed in the same input box
