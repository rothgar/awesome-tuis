...
- [PAD](https://github.com/T1mn/pad) A tmux-native control panel for Codex, Claude Code, Gemini CLI, and other terminal agents with live previews, pane jumps, notifications, and launcher support.
