...
- [cupstui](https://github.com/icortesb/cupstui) A TUI for CUPS: watch the print queue, manage printers and quotas, send files, and read the daemon logs, without leaving the terminal.
