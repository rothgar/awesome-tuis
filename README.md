...
- [clamp-cc](https://github.com/AmmarHassona/clamp-cc) Terminal UI for interactive Claude Code context compaction. Tag turns, generate targeted /compact instructions, with tmux integration and tag persistence.
