...
- [mnml](https://github.com/chris-mclennan/mnml) An NvChad-meets-VSCode terminal IDE in Rust — pluggable vim/standard input, integrations SDK, HTTP client, LSP, Git graph.
