...
- [cmdpeek](https://github.com/esperanza-volkov/cmdpeek) Interactive flag explorer and command builder that parses any CLI's `--help` live into a searchable picker to assemble commands.
