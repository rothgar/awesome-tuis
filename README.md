...
- [agenttrace](https://github.com/luoyuctl/agenttrace) TUI observability for AI coding agent sessions, cost, tokens, tool failures, latency, anomalies, health, and diffs.
