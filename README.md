...
- [baton](https://github.com/cmj0121/baton) A terminal multiplexer for AI coding agents with a live dashboard of the fleet, work items, a task queue, and per-panel resource caps
