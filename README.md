...
- [llm.log](https://github.com/lanesket/llm.log) A local MITM proxy with TUI dashboard for monitoring LLM API calls — token usage, costs, latency and full request inspector. Supports OpenAI, Anthropic and OpenRouter. Zero code changes, single binary.
