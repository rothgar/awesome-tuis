...
- [PentestHub](https://github.com/rudisec/pentesthub) A terminal-based pentesting workspace that unifies security tools, AI-assisted automation, notes, logs, in a single interface.
