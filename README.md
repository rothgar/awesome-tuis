...
- [ordewell](https://github.com/ordewell/ordewell) Interactive TUI that orchestrates coding agents (Claude Code, Codex, OpenCode) from a single goal into an ordered, editable plan
