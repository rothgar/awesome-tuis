...
- [aloc](https://github.com/modern-tooling/aloc) A modern, AI-augmented lines of code counter built with Rust and Ratatui. Provides accurate LOC metrics with effort estimation profiles.
